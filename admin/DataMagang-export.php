...
header("Content-Disposition: attachment; filename=laporan-Data-Magang-Aktif " . $tanggalAwal . "-" . $tanggalAkhir . ".xls"); 

?>

<p align="center" style="font-weight:bold;font-size:16pt">LAPORAN DATA MAGANG AKTIF</p>

<?php
    $view = null; // Initialize $view variable
        
    if (isset($_POST['exportDataMagang'])) {
        // Mengambil nilai dari form
        $tanggalAwal = $_POST['tanggalAwal'];
        $tanggalAkhir = $_POST['tanggalAkhir'];
